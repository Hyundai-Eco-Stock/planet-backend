...
public class MemberStockInfoController {
    ...
    public ResponseEntity<?> sellEcoStock(@RequestBody SellStockRequest request,
        @LoginMemberId Long loginMemberId) {

        log.info("sell stock request:{} {}", request, loginMemberId);

        SellResponse sellResponse = ecoStockService.sellStock(loginMemberId, request);

        return ResponseEntity.ok(sellResponse);
    }
